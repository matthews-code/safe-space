...
router.post(
  "/signup",
  [db.upload.any(), validation.signupValidation()],
  profileController.signup
);
router.post(
  "/editaccount",
  [db.upload.any(), validation.editAccountValidation()],
...
router.post(
  "/createentry",
  [db.upload.any(), validation.createEntryValidation()],
...
router.post(
  "/createletter",
  [db.upload.any(), validation.createLetterValidation()],
